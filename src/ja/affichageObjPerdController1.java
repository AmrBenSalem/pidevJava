...
import static ja.affichageObjTrouv1Controller.id_Objet;
 ...
 * @author bader
 */
public class affichageObjPerdController1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (Objet o : Objets) {
            ...
            label.setOnMouseClicked((event9) -> {
                ...
                Parent root;
                try {
                    AffichObjPerdSingle.idob = Integer.parseInt(id_Objet);
                    root = FXMLLoader.load(getClass().getResource("AffichObjPerdSingle.fxml"));
        ...
        for (Objet o : Objets) {
            ...
            if (o.getType().toLowerCase().contains(recherche_input.getText().toLowerCase())
                ...
                label.setOnMouseClicked((event9) -> {
                    ...
                    id_Objet = labe.getText();
                    AffichObjPerdSingle.idob = o.getId();
                    Node node = null;
                    FXMLLoader loader = new FXMLLoader();

                    try {
                        node = (Parent) loader.load(getClass().getResourceAsStream("AffichObjPerdSingle.fxml"));
                    } catch (IOException ex) {
